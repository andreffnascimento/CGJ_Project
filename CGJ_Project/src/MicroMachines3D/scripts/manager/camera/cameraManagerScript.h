#ifndef __mm3d_scripts_manager_camera_cameraManagerScript_h__
#define __mm3d_scripts_manager_camera_cameraManagerScript_h__
...
#endif // !__mm3d_scripts_manager_camera_cameraManagerScript_h__